...
console.log("Env-", process.env.PUPPETEER_SKIP_CHROMIUM_DOWNLOAD);

if (process.env.PUPPETEER_SKIP_CHROMIUM_DOWNLOAD) {
  console.log(
    '**INFO** Skipping Firefox download. "PUPPETEER_SKIP_CHROMIUM_DOWNLOAD" environment variable was found.'
  );
  return;
}

console.log('download Firefox from Internet ....');
